...
public class MainActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener{
    ...
    private static final int POS_KOOVETERS = 3;
    ...
    public void onItemSelected(int position) {
        ...
        else if (position == POS_KOOVETERS){
            KoovetersFragment koovetersFragment = new KoovetersFragment();
            transaction.replace(R.id.container, koovetersFragment);
        }
